...
defaults write NSGlobalDomain NSqAutomaticSpellingCorrectionEnabled -bool false
...
# https://apple.stackexchange.com/questions/306210/how-to-set-a-default-folder-when-opening-finder
